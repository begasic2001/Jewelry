...
List<CategoryProductModel> menCategoryData = [
  CategoryProductModel(
    productImage:
        'https://cartino.vn/upload/product/fmn-6-trang-2632.jpg',
    productModel: '5,340 sp',
    productName: 'Nhẫn',
  ),
  CategoryProductModel(
    productImage:
        'https://cdn3.dhht.vn/wp-content/uploads/2021/10/DW00400166.jpg',
    productModel: '1,232 sp',
    productName: 'Vòng Cổ',
  ),
  CategoryProductModel(
    productImage:
        'https://sansan.vn/wp-content/uploads/2020/06/Bong-tai-giot-nuoc.png',
    productModel: '5,340 sp',
    productName: 'Hoa Tai',
  ),
];
